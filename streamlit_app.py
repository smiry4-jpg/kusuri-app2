...
RAW_MEDICINE_DATABASE = [
    # ==================== 👨 大人用 ====================
    {
        "id": "M001-200", "name": "カロナール錠 200mg（アセトアミノフェン）", "rank": 1, "target": "adult",
    ...
    {
        "id": "M001-300", "name": "カロナール錠 300mg（アセトアミノフェン）", "rank": 2, "target": "adult",
    ...
    {
        "id": "M003-60", "name": "アレグラ錠 60mg（フェキソフェナジン塩酸塩）", "rank": 5, "target": "adult",
    ...
    {
        "id": "M004-15", "name": "メジコン錠 15mg（デキストロメトルファン臭化水素酸塩）", "rank": 6, "target": "adult",
    ...
    {
        "id": "M005-250", "name": "ムコダイン錠 250mg（カルボシステイン）", "rank": 7, "target": "adult",
    ...
    {
        "id": "M006-10", "name": "ガスター錠 10mg（ファモチジン）", "rank": 9, "target": "adult",
    ...
    {
        "id": "M007-10", "name": "セレキノン錠 100mg（トリメブチンマレイン酸塩）", "rank": 10, "target": "adult",
    ...
    {
        "id": "C002-DS", "name": "オノンドライシロップ 10%（プランルカスト）", "rank": 3, "target": "child",
    ...
    {
        "id": "C003-10", "name": "アスベリン散 10%（チペピジンヒバイン酸塩）", "rank": 4, "target": "child",
    ...
    {
        "id": "C004-50", "name": "ムコダイン細粒 50%（カルボシステイン）", "rank": 5, "target": "child",
    ...
    {
        "id": "C006-R", "name": "ラックビー微粒N（耐性乳酸菌）", "rank": 7, "target": "child",
